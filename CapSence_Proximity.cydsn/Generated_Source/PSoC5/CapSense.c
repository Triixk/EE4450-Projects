...
uint8 CYXDATA * const CYCODE CapSense_pcTable[] = {
    (uint8 CYXDATA *)CapSense_PortCH0__ProximitySensor0_0__PROX__PC, 
};

const uint8 CYCODE CapSense_portTable[] = {
    CapSense_PortCH0__ProximitySensor0_0__PROX__PORT, 
};

const uint8 CYCODE CapSense_maskTable[] = {
    CapSense_PortCH0__ProximitySensor0_0__PROX__MASK,
};

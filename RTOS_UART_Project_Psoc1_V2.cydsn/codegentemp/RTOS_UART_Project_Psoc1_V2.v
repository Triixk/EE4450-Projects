// ======================================================================
// RTOS_UART_Project_Psoc1_V2.v generated from TopDesign.cysch
// 12/14/2019 at 10:15
...
module UART_v2_50_4 (
	...
	cy_clock_v1_0
		#(.id("10c9fbec-c81d-40ca-865e-cf28f1011a3a/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("13020833333.3333"),
		  .is_direct(0),
...
module top ;
    ...
    PWM_v3_30_3 PWM_Music (
        ...
        .ph1(Net_385),
        .ph2(Net_386));
    defparam PWM_Music.Resolution = 16;
	...
	cy_psoc3_pins_v1_10
		#(.id("ff3daf03-45ae-40b8-9bb3-d0cfafc2c207"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bd1e2dad-dcd5-47ad-8ee4-3250fdb5bb2a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),

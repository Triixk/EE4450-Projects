...
*
* \funcusage
*  \snippet LEDC_SUT.c usage_LEDC_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet LEDC_SUT.c usage_LEDC_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet LEDC_SUT.c usage_LEDC_Read  
*******************************************************************************/
...
* preferred LEDC_Read() API because the 
* LEDC_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet LEDC_SUT.c usage_LEDC_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: LEDC_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use LEDC_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - LEDC_0_INTR       (First pin in the list)
    *  - LEDC_1_INTR       (Second pin in the list)
    *  - ...
    *  - LEDC_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet LEDC_SUT.c usage_LEDC_SetInterruptMode
    *******************************************************************************/
    void LEDC_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & LEDC_0_INTR) != 0u) 
		{ 
			 LEDC_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet LEDC_SUT.c usage_LEDC_ClearInterrupt
    *******************************************************************************/

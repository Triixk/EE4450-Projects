...
#define UART_RXInternalInterrupt__INTC_PRIOR_NUM 4u
...
#define UART_TXInternalInterrupt__INTC_PRIOR_NUM 4u
...
#define CY_PROJECT_NAME "RTOS_UART_StringMessage_Copy_01"

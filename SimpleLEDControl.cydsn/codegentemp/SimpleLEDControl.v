// ======================================================================
// SimpleLEDControl.v generated from TopDesign.cysch
// 11/14/2019 at 14:06
...
module top ;
    ...
    CyStatusReg_v1_90 Status_nSW (
        ...
        .intr(Net_19),
        .status_bus(8'b0));
    defparam Status_nSW.Bit0Mode = 0;
    defparam Status_nSW.Bit1Mode = 0;
    defparam Status_nSW.Bit2Mode = 0;
    defparam Status_nSW.Bit3Mode = 0;
    defparam Status_nSW.Bit4Mode = 0;
    defparam Status_nSW.Bit5Mode = 0;
    defparam Status_nSW.Bit6Mode = 0;
    defparam Status_nSW.Bit7Mode = 0;
    defparam Status_nSW.BusDisplay = 0;
    defparam Status_nSW.Interrupt = 0;
    defparam Status_nSW.MaskValue = 0;
    defparam Status_nSW.NumInputs = 1;

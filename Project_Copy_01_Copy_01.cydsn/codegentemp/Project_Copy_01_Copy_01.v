// ======================================================================
// Project_Copy_01_Copy_01.v generated from TopDesign.cysch
// 11/21/2019 at 14:36
...
module UART_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("5b83224d-f2a6-47f2-8413-97de8f3268f3/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
    ...
    UART_v2_50_0 UARTB (
        ...
        .rx_data(Net_49),
        .rx_clk(Net_50));
    defparam UARTB.Address1 = 0;
    defparam UARTB.Address2 = 0;
    defparam UARTB.EnIntRXInterrupt = 0;
    defparam UARTB.EnIntTXInterrupt = 0;
    defparam UARTB.FlowControl = 0;
    defparam UARTB.HalfDuplexEn = 0;
    defparam UARTB.HwTXEnSignal = 1;
    defparam UARTB.NumDataBits = 8;
    defparam UARTB.NumStopBits = 1;
    defparam UARTB.ParityType = 0;
    defparam UARTB.RXEnable = 1;
    defparam UARTB.TXEnable = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("499fa0e6-9ff7-49d4-b4e9-ba9a3520af38"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bd037f59-aa15-41db-bd57-0e2ec9c5c879"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
